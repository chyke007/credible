                ...
                <div class="card">
                  <div class="card-body">
                    <form @submit.prevent="register">
                      ...
                      <span class="text-secondary font-13"> Credpal</span>
                      <div class="form-over">
                        ...
                        <div class="form-group">
                          <label class="black" for="fname">First Name</label>
                          <input
                            v-model="fname"
                            type="text"
                            class="form-control"
                        ...
                        <div class="form-group">
                          <label class="black" for="sname">Last Name</label>
                          <input
                            v-model="sname"
                            type="text"
                            class="form-control"
                        ...
                        <div class="form-group">
                          <label class="black" for="sname"
                            >Referral code (Leave blank if none)</label
                          >
                          <input
                            v-model="referral"
                            type="text"
                        ...
                        <div class="form-group">
                          <label class="black" for="password">Password</label>
                          <input
                            v-model="password"
                            type="password"
                            class="form-control"
                        ...
                        <div class="form-group">
                          <label class="black" for="rpassword"
    ...
    async register() {
      ...
      if (check.valid == false) {
        ...
        if (check.errors.fname)
          return this.$toastr.e(check.errors.fname, "Invalid credentials", {
            timeOut: 5000,
          });
        if (check.errors.sname)
          return this.$toastr.e(check.errors.sname, "Invalid credentials", {
            timeOut: 5000,
          });
        ...
        if (check.errors.rpassword)
          return this.$toastr.e(check.errors.rpassword, "Invalid credentials", {
            timeOut: 5000,
          });
        if (check.errors.match)
          return this.$toastr.e(check.errors.match, "Invalid credentials", {
            timeOut: 5000,
          });
        if (check.errors.pass_l)
          return this.$toastr.e(check.errors.pass_l, "Invalid credentials", {
            timeOut: 5000,
          });
      }
      ...
      let res = await this.loadData(this.REGISTERURL, requestBody, "POST");
      this.hideLoader();
      if (!res) return;
