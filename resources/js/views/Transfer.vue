                ...
                <div class="col-8">
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        >
                            ...
                            <div class="card card-overview m-b-30">
                                <div class="card-body overview">
                                    <img
                                        src="@/js/assets/images/wallet.svg"
                                        class="coin"
                                    /><span
                        ...
                        >
                            ...
                            <form
                                class="form"
                                @submit.prevent="instantTransfer"
                            >
                                <label
                                    class="my-1 mr-2"
                        ...
                        >
                            ...
                            <form class="form" @submit.prevent="futureTransfer">
                                <label class="my-1 mr-2" for="future"
                                    >Future Date:</label
                                >
                                <input
                                    type="datetime-local"
                                ...
                                />
                                <br />
                                <label class="my-1 mr-2" for="amount"
                                    >Choose Amount</label
                                >
                                <select
                                    v-model="amount"
        ...
        return {
            ...
            columns: [
...

                {
                    ...
                    th: "Planned time",
                    render(row, cell, index) {
                        return moment(row.transfer_time).format(
                            "DD-MM-YYYY: h:mm:ss"
                        );
                    }
                },
    ...
    methods: {
        ...
        async instantTransfer() {
            let confirmed = confirm(
                `Are you sure you want to transfer N${
                    this.amount
        ...
        async futureTransfer() {
            ...
            let confirmed = confirm(
                `Are you sure you want to schedule N${
                    this.amount
                } to be transferred to your bank account at the chosen date?`
            );
            if (!confirmed) return;

            if (
                moment(this.future).isBefore(
